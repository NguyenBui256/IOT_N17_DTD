...
reader.onload = function(event) {
  ...
  try {
    ...
    var hasValidVehicles = 'vehicles' in data && Array.isArray(data.vehicles);
    var hasValidJobs = 'jobs' in data && Array.isArray(data.jobs);
    var hasValidShipments = 'shipments' in data && Array.isArray(data.shipments);
    validJsonInput = hasValidVehicles && (hasValidJobs || hasValidShipments);
  } catch(e) {}
